...
class TeraVMVirtualBladeDriver(ResourceDriverInterface, VirtualTrafficGeneratorResourceDriverInterface):
    SHELL_NAME = "TeraVM Virtual Blade"
    ...
    def get_inventory(self, context):
        ...
        with ErrorHandlingContext(logger):
            ...
            vblade_resource = TeraVMTrafficGeneratorVBladeResource.from_context(context=context,
